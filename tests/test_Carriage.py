...
class TestCarriage(TestCase):
    ...
    def setUp(self):
        ...
        self.carriage = self.machine.carriage
    ...
    def test_move_to_needle(self):
        self.carriage.move_to_needle(self.machine.get_specified_needle(True, 10))
        ...
        self.carriage.move_to_needle(self.machine.get_specified_needle(True, 20))
        self.assertTrue(self.carriage.position_on_bed.on_bed)
        self.assertEqual(self.carriage.slot_number, 20)
        self.assertIs(self.carriage.last_direction, Carriage_Pass_Direction.Rightward)
        self.assertIs(self.carriage.last_set_direction, Carriage_Pass_Direction.Leftward)

        self.carriage.move_to_needle(self.machine.get_specified_needle(True, 15))
        self.assertTrue(self.carriage.position_on_bed.on_bed)
    ...
    def test_move_in_direction(self):
        self.carriage.move_in_direction(self.machine.get_specified_needle(True, 10), Carriage_Pass_Direction.Leftward)
        self.assertTrue(self.carriage.position_on_bed.on_bed)
        self.assertEqual(self.carriage.slot_number, 10)
        self.assertIs(self.carriage.last_direction, Carriage_Pass_Direction.Leftward)
        self.assertIs(self.carriage.last_set_direction, Carriage_Pass_Direction.Leftward)

        self.carriage.move_in_direction(self.machine.get_specified_needle(True, 10), Carriage_Pass_Direction.Rightward)
        self.assertTrue(self.carriage.position_on_bed.on_bed)
        self.assertEqual(self.carriage.slot_number, 10)
        self.assertIs(self.carriage.last_direction, Carriage_Pass_Direction.Rightward)
        self.assertIs(self.carriage.last_set_direction, Carriage_Pass_Direction.Rightward)

        self.carriage.move_in_direction(self.machine.get_specified_needle(True, 20), Carriage_Pass_Direction.Leftward)
        self.assertTrue(self.carriage.position_on_bed.on_bed)
        self.assertEqual(self.carriage.slot_number, 20)
        self.assertIs(self.carriage.last_direction, Carriage_Pass_Direction.Leftward)
        self.assertIs(self.carriage.last_set_direction, Carriage_Pass_Direction.Leftward)

        self.carriage.move_in_direction(self.machine.get_specified_needle(True, 15), Carriage_Pass_Direction.Rightward)
        self.assertTrue(self.carriage.position_on_bed.on_bed)
        self.assertEqual(self.carriage.slot_number, 15)
        self.assertIs(self.carriage.last_direction, Carriage_Pass_Direction.Rightward)
        self.assertIs(self.carriage.last_set_direction, Carriage_Pass_Direction.Rightward)
